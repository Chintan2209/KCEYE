...
class corneal_top_gen:
    ...
    def zernike_smoothening(self, image_name, plot_x, plot_y, plot_z, 
        ...
        for zern_deg in self.zernike_degree:
            ...
            cart.make_cart_grid(plot_x, plot_y)   # Prajwal changed this and commented above line.
            ...
            cart.make_cart_grid(xv, yv)   # Prajwal changed this and commented above line.
